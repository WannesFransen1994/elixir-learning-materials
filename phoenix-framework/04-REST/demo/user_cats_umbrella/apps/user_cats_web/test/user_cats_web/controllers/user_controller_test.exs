defmodule UserCatsWeb.UserControllerTest do
  use UserCatsWeb.ConnCase

  alias UserCats.UserContext

  @create_attrs %{date_of_birth: ~D[2010-04-17], first_name: "some first_name", last_name: "some last_name"}
