...
\begin{frame}
    ...
    \begin{tikzpicture}
        ...
        \draw[thick] (1,1) -- node[below] {Cowboy Layer} (9,1);
        % Lower horizontal line
        \tiny
        ...
        \draw[thick] (1,-1) -- node[below] {Plug Layer} (9,-1);
        % Lower horizontal line
        \tiny
        ...
        \draw[thick] (1,-3) -- node[below] {Ecto Layer} (9,-3);
        % Lower horizontal line
        \tiny
